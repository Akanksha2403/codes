...
// ll func2(ll a, ll b, ll c);

ll func2(ll a, ll b, ll c) // a > b
{
    a = a - b;
    if (a % 2 == 0)
    {
...
ll func1(ll a, ll b, ll c, map<ll, ll> memo) //recursive
{
    ...
    ll oper1 = 1 + func1(a * c, b, c, memo);
    ll oper2 = 1 + func1(a - 1, b, c, memo);
    ll oper3 = 1 + func1(a - 2, b, c, memo);

    return memo[a] = min(min(oper1, oper2), oper3);
}
